...
export default function HowItWorksPage() {
  return (
    <div className="policy-page content-wrap content-wrap--detail">
      ...
      <div className="policy-actions"><Link className="button button--outline" href="/">LegendStudy LAB 소개로 돌아가기</Link><Link className="button button--primary" href="/support/">지원 상태 확인하기</Link></div>
    </div>
  );
}
