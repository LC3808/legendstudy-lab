...
export const metadata = buildPublicMetadata(
  "LS LAB 이용 방법",
  "LegendStudy+ LS LAB의 현재 공개 범위와 향후 논술 서비스 흐름을 안내합니다.",
  "/lab/how-it-works",
);
...
export default function HowItWorksPage() {
  return (
    <div className="policy-page content-wrap content-wrap--detail">
      <p className="eyebrow eyebrow--accent">LS LAB / HOW IT WORKS</p>
      <div className="policy-page__heading"><h1>현재 공개 범위를<br />먼저 안내합니다.</h1><ReleaseStatusLabel status="SERVICE_PREPARING" /></div>
      <p className="policy-page__lead">LS LAB은 완성된 유료 서비스가 아닙니다. 아래 흐름은 논술 서비스가 준비될 때의 방향을 설명하며, 현재 자동으로 실행되거나 제공되는 기능을 뜻하지 않습니다.</p>
      ...
      <section className="policy-section"><h2>현재 사용할 수 없는 기능</h2><p>현재 LS LAB은 실제 로그인, 공유 계정, 결제, 구독, credit, 대학별 공식 문제 전문, 자동 AI 첨삭, 점수 결과 저장을 제공하지 않습니다. 준비되지 않은 기능은 신청이나 결제 화면으로 연결하지 않습니다.</p></section>
      ...
      <div className="policy-actions"><Link className="button button--outline" href="/lab">LS LAB 소개로 돌아가기</Link><Link className="button button--primary" href="/support">지원 상태 확인하기</Link></div>
    </div>
  );
}
